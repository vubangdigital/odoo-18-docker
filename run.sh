...
git clone --depth=1 https://github.com/vubangdigital/odoo-18-docker $DESTINATION
...
echo "Odoo started at http://localhost:$PORT | Master Password: vubangdigital.com | Live chat port: $CHAT"